...
#	cur.execute('INSERT INTO demo_user_table (userid,demoname,role,demo_status,duration) VALUES ("prakash","newDemo3 ",0,1,"100")') 
	cur.execute('INSERT INTO demodetails(demoid,demoname,description,device_details,status) VALUES (1,"Autodot1x","Simplify Dot1x","telnet 10.104.59.132 200",0)') 
	cur.execute('INSERT INTO demodetails(demoid,demoname,description,device_details,status) VALUES (2,"AutoMacSec","Simplifying MacSec","telnet 10.104.59.133 201",0)') 
	cur.execute('INSERT INTO demodetails(demoid,demoname,description,device_details,status) VALUES (3,"iShoot","Debugging a feature","telnet 10.104.59.134 202",0)') 
	cur.execute('INSERT INTO demodetails(demoid,demoname,description,device_details,status) VALUES (4,"DSA","Differentiated Services Architecture","telnet 10.104.59.135 203",0)') 
