...
with db:
	...
	cur.execute('DROP TABLE IF EXISTS karthik_table')
	cur.execute('CREATE TABLE karthik_table(userid TEXT NOT NULL,demoname TEXT,role INTEGER NOT NULL DEFAULT 0,demo_status INTEGER NOT NULL DEFAULT 0,duration TEXT)')
